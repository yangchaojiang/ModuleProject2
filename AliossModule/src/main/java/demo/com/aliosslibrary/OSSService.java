...
public class OSSService {
    ...
    private static volatile String bucket;//getBucket名称
     ...
     *
     * @param endpoints        唯一
     * @param accessKeyIds     key
     * @param accessKeySecrets accessKeySecrets
     * @param buckets          Bucket名称
     ***/
    public static void initId(String endpoints, String accessKeyIds, String accessKeySecrets, String buckets) {
        endpoint = endpoints;
